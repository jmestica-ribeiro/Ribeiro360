...
- **Inspector de Arquitectura y Legibilidad**: `npm run audit:architecture` *(**OBLIGATORIO:** Revise la salud del código, limites de líneas por archivo y cruces de arquitectura con este script para mantener las buenas prácticas del proyecto).*
...
- **Auditor CSS UI/UX**: `npm run audit:styles` *(**OBLIGATORIO:** Ejecútelo antes de dar por terminado cualquier cambio sobre diseño Visual para corroborar que no se usó CSS estático).*
