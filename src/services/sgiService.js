...
export async function fetchSgiEstadisticasData() {
  const [
    ...
    supabase.from('inc_incidentes').select('id, numero, estado, gerencia, sitio, tipo_incidente, clasificacion, paso_actual, fecha, created_at, tipo_lesion, parte_cuerpo, atencion_medica, lesionado_id'),
  ]);
